...
void gibbsTwoSampleAR_trend(double *y, int N, double *X, int p, double rscaleInt, double rscaleSlp,
                            ...
                            int iterations, double sdmet, double *chains, double *postdens, int progress, int *miss, int Nmiss,
                            SEXP pBar, SEXP rho)
{
...
SEXP RgibbsTwoSampleAR_trend(SEXP yR, SEXP NR, SEXP XR, SEXP pR, SEXP rscaleIntR, SEXP rscaleSlpR, SEXP alphaThetaR, SEXP betaThetaR, SEXP loIntR, SEXP upIntR, SEXP loSlpR, SEXP upSlpR, SEXP iterationsR, SEXP sdmetR, SEXP missR, SEXP NmissR, SEXP progressR, SEXP pBar, SEXP rho)
{
  ...
  int Nmiss = INTEGER_VALUE(NmissR);
	...
	gibbsTwoSampleAR_trend(y, N, X, p, rscaleInt, rscaleSlp, alphaTheta, betaTheta, loInt, upInt, loSlp, upSlp, iterations, sdmet, REAL(chainsR), REAL(postdensR), progress, miss, Nmiss, pBar, rho);
