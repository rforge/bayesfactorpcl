analyzeModelList <- function(modelList, data, globalProgress = NULL, singleProgress = NULL)
	{

		modelList = lapply(modelList, .cleanModel)
		modelList = lapply(modelList, analyzeModel, data = data, singleProgress = NULL)
		return(modelList)
		# increment progress
	}
...
analyzeModel <- (model, data, singleProgress = NULL)
	{
